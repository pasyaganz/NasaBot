      ...
      case 'remove':
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            let pp = 'https://i.ibb.co/x8bxx4Q/IMG-20220119-WA0454.jpg'
            try {
              ...
              let wel = `https://hardianto-chan.herokuapp.com/api/welcome3?profile=${pp}&name=${encodeURIComponent(this.getName(user))}&bg=https://i.ibb.co/RCCcgpJ/IMG-20211001-WA0019.png&namegb=${encodeURIComponent(this.getName(jid))}&member=${encodeURIComponent(groupMetadata.participants.length)}`
              let lea = `https://hardianto-chan.herokuapp.com/api/goodbye3?profile=${pp}&name=${encodeURIComponent(this.getName(user))}&bg=https://i.ibb.co/RCCcgpJ/IMG-20211001-WA0019.png&namegb= ${encodeURIComponent(this.getName(jid))}&member=${encodeURIComponent(groupMetadata.participants.length)}`
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintah ini hanya dapat digunakan oleh _*Pemilik Asli*_',
